...
public class UniGsmAlphabet {
    public static final byte GSM_EXTENDED_ESCAPE = 27;
    private static final String TAG = "UniGsmAlphabet";
    ...
    private static String mEncodeType = "0";
    private static boolean mIsUse7bitOnly = false;
    private static boolean sDisableCountryEncodingCheck = false;

    private UniGsmAlphabet() {
    }
    ...
    public static String getEncodeType() {
        ...
        try {
            ...
            Rlog.d(TAG, "getEncodeType  e= " + e);
        }
        if (application == null) {
            return mEncodeType;
        }
        Context context = application.getApplicationContext();
        String encodeType = Settings.Global.getString(context.getContentResolver(), "persist.radio.sms_encode_type");
        if (encodeType != null) {
            mEncodeType = encodeType;
        }
        Rlog.d(TAG, "getEncodeType = " + mEncodeType);
        return mEncodeType;
    }

    public static boolean isUse7bitOnly() {
        Rlog.d(TAG, "isUse7bitOnly  mIsUse7bitOnly = " + mIsUse7bitOnly);
        return mIsUse7bitOnly;
    }

    public static void setUse7bitOnly(boolean isUse7bitOnly) {
        Rlog.d(TAG, "setUse7bitOnly  isUse7bitOnly = " + isUse7bitOnly);
        mIsUse7bitOnly = isUse7bitOnly;
    }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: com.android.internal.telephony.EncodeException */
    ...
    public static byte[] stringToGsm7BitPackedWithHeader(String data, byte[] header, int languageTable, int languageShiftTable) throws EncodeException {
        ...
        byte[] ret = stringToGsm7BitPacked(data, headerSeptets, "1".equals(mEncodeType), languageTable, languageShiftTable);
    ...
    public static byte[] stringToGsm7BitPacked(String data, int startingSeptetOffset, boolean throwException, int languageTable, int languageShiftTable) throws EncodeException {
        ...
        Rlog.i("SmsMessageUniGsmAlphabet", "throwException:" + throwException + "; septetCount=" + septetCount);
        int i = -1;
        if (septetCount == -1) {
    ...
    public static String gsm7BitPackedToString(byte[] pdu, int offset, int lengthSeptets, int numPaddingBits, int languageTable, int shiftTable) {
        ...
        Rlog.d("SmsMessage-UniGsmAlphabet", "gsm7BitPackedToString, offset:" + offset + ", lengthSeptets:" + lengthSeptets + ", numPaddingBits:" + numPaddingBits + ", languageTable:" + languageTable2 + ", shiftTable:" + shiftTable2);
    ...
    */
    public static void stringToGsm8BitUnpackedField(java.lang.String r9, byte[] r10, int r11, int r12) {
        /*
            r0 = r11
            android.util.SparseIntArray[] r1 = com.android.internal.telephony.UniGsmAlphabet.sCharsToGsmTables
            r2 = 0
            r1 = r1[r2]
            android.util.SparseIntArray[] r3 = com.android.internal.telephony.UniGsmAlphabet.sCharsToShiftTables
            r2 = r3[r2]
            r3 = 0
            int r4 = r9.length()
        Lf:
        ...
        L4d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.UniGsmAlphabet.stringToGsm8BitUnpackedField(java.lang.String, byte[], int, int):void");
    }
    ...
    public static boolean isGsmSeptets(char c) {
        ...
        if (iArr.length > 0) {
            for (int i : iArr) {
                if (sCharsToGsmTables[i].get(c, -1) != -1) {
                    return true;
                }
            }
        } else if (sCharsToGsmTables[0].get(c, -1) != -1) {
            return true;
        }
        int[] iArr2 = sEnabledSingleShiftTables;
        if (iArr2.length > 0) {
            for (int i2 : iArr2) {
                if (sCharsToGsmTables[i2].get(c, -1) != -1) {
                    return true;
                }
            }
        } else if (sCharsToShiftTables[0].get(c, -1) != -1) {
            return true;
        }
        return false;
    }
    ...
    private static class LanguagePairCount {
        ...
        LanguagePairCount(int code) {
            ...
            int maxSingleShiftCode = UniGsmAlphabet.sHighestEnabledSingleShiftCode;
            ...
            for (int i = 1; i <= maxSingleShiftCode; i++) {
                if (UniGsmAlphabet.sEnabledSingleShiftTables[tableOffset] == i) {
                    tableOffset++;
                } else {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: com.android.internal.telephony.EncodeException */
    public static byte[] isAsciiStringToGsm8BitUnpackedField(String s) throws EncodeException {
    ...
    public static byte[] stringToGsmAlphaSS(String s) throws EncodeException {
        int alphaType;
        int tempUcs2;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (tempUcs22 > 127) {
                ...
                maxUcs2 = tempUcs22 > maxUcs2 ? tempUcs22 : maxUcs2;
                minUcs2 = tempUcs22 < minUcs2 ? tempUcs22 : minUcs2;
            }
        }
        if (count == 0 || !isUcs2) {
            alphaType = 0;
        } else if (maxUcs2 - minUcs2 > 128 || count < 3) {
            alphaType = 80;
        } else if (minUcs2 >= 32768) {
            alphaType = 82;
        ...
        switch (alphaType) {
            case 0:
                return isAsciiStringToGsm8BitUnpackedField(s.toString());
            case 80:
                byte[] ret = isAsciiStringToGsm8BitUnpackedField(s.toString());
                ret[0] = -128;
                return ret;
            case 81:
                byte[] ret2 = new byte[count + 3];
                ret2[0] = -127;
                ret2[1] = (byte) count;
                ret2[2] = (byte) (minUcs2 >> 7);
                for (int i2 = 0; i2 < count; i2++) {
                    int tempUcs23 = s.codePointAt(i2) & 127;
                    if (s.codePointAt(i2) >= 128) {
                        ret2[i2 + 3] = (byte) (tempUcs23 + 128);
                    } else {
                        ret2[i2 + 3] = convertAsciiCharToGsm8BitUnpacked((char) s.codePointAt(i2));
                    }
                }
                return ret2;
            case 82:
                byte[] ret3 = new byte[count + 4];
                ret3[0] = -126;
                ret3[1] = (byte) count;
                ret3[2] = (byte) (minUcs2 >> 8);
                ret3[3] = (byte) (minUcs2 & 255);
                for (int i3 = 0; i3 < count; i3++) {
                    if (s.codePointAt(i3) >= 128) {
                        int tempUcs24 = s.codePointAt(i3) - minUcs2;
                        tempUcs2 = tempUcs24 + 128;
                    } else {
                        int tempUcs25 = s.codePointAt(i3);
                        tempUcs2 = charToGsm((char) (tempUcs25 & 127));
                    }
                    ret3[i3 + 4] = (byte) tempUcs2;
                }
                return ret3;
            default:
                return isAsciiStringToGsm8BitUnpackedField(s.toString());
    ...
    private static byte convertAsciiCharToGsm8BitUnpacked(char c) {
        SparseIntArray charToLanguageTable = getCharsToGsmTables()[0];
        SparseIntArray charToShiftTable = getCharsToShiftTables()[0];
    ...
    public static String getGsm8BitString(byte[] data, int offset, int length, String characterset) {
        try {
            String gsm8Bit = GsmAlphabet.gsm8BitUnpackedToString(data, offset, length, characterset);
            return gsm8Bit;
        } catch (StringIndexOutOfBoundsException e) {
            Rlog.e(TAG, "getGsm8BitString/exception is happen here!", e);
            return null;
        }
    }

    public static String getGsm7BitString(byte[] data, int offset, int length) {
        if (length <= 0) {
            return null;
        }
        int index = length;
        ...
        Rlog.d(TAG, "getGsm7BitString index=" + index);
        try {
            String gsm7Bit = GsmAlphabet.gsm7BitPackedToString(data, offset, (index * 8) / 7);
            return gsm7Bit;
        } catch (StringIndexOutOfBoundsException e) {
            Rlog.e(TAG, "getGsm7BitString/exception is happen here!", e);
            return null;
        }
    }

    public static SparseIntArray[] getCharsToGsmTables() {
        return sCharsToGsmTables;
    }

    public static SparseIntArray[] getCharsToShiftTables() {
        return sCharsToShiftTables;
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: com.android.internal.telephony.EncodeException */
    public static byte[] stringToGsmAlphaSSForDialer(String s) throws EncodeException {
        try {
            return stringToGsmAlphaSS(s);
        } catch (EncodeException e) {
